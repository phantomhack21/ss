  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body>
        ...
        <table  style="margin: 10px auto;" align="center" cellspacing="0">
          <thead>
            <tr align="center">
              <th bgcolor="#01A9DB">
          ...
          <tr align="center">
            ...
            <!--<td>
              <font size="4">
                <xsl:value-of select="LogReport/FileInfo/@wordcount"/>
              </font>
            </td>-->
            <td>
              <font size="4">
        ...
        <hr/>
        <marquee>
          <font size="2" face="Arial" color="blue">Copyright &#169; 2015-2016 SPi Global, Chennai, India. All rights reserved.</font>
        </marquee>
      </body>
    </html>
  </xsl:template>
